...
export class AllModulesService {
  ...
  // Get Method Api
  get(type:string): Observable<AllModulesData[]> {
  ...
  // Post Method Api
  add(user: any, type:string): Observable<any> {
    this.apiurl = `api/${type}`;
    user.id = null;
    return this.http
  ...
  // Update Method Api
  update(user: any, type:string): Observable<any> {
    this.apiurl = `api/${type}`;
  ...
  // Delete Method Api
  delete(id: id, type:string): Observable<id> {
    this.apiurl = `api/${type}`;
